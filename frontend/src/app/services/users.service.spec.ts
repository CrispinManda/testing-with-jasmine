...
describe('UserService', () => {
  ...
  it('should register a user', fakeAsync(() => {
    const mockUser: User = {
      user_name: 'crispin ',
      email: 'crispinmanda08@gmail.com',
      password: '@Santa2023',
    };
  ...
  it('should get a user by ID', fakeAsync(() => {
    ...
    req.flush({
      ...
      user: {
        ...
        email: 'user_jamesuser@gmail.com',
        user_name: 'crispin alan',
      },
    });
    ...
    req.flush({
      ...
      users: [
        ...
        },
        {
          ...
          user_name: 'crispin ',
          email: 'crispin aberi9@gmail.com',
        },
        {
          user_id: '185448a1-7a07-4a0d-b4f9-a9761dc811ea',
          user_name: 'James',
          email: 'James.wambui@thejitu.com',
        },
        {
          user_id: '2f44dc9b-ab86-4a2b-9889-b3cd95ae380f',
          user_name: 'crispin ',
